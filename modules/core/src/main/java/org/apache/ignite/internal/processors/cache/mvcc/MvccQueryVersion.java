 ...
 *
 */
public class MvccQueryVersion implements Message {
    /** */
    private long cntr;
     ...
     */
    public MvccQueryVersion(long cntr, Collection<GridCacheVersion> activeTxs) {
        this.cntr = cntr;
    ...
    @Override public boolean readFrom(ByteBuffer buf, MessageReader reader) {
        ...
        return reader.afterMessageRead(MvccQueryVersion.class);
    }
