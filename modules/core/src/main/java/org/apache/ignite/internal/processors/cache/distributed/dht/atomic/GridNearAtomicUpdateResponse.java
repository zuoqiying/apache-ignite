...
public class GridNearAtomicUpdateResponse extends GridCacheMessage implements GridCacheDeployable {
    ...
    /** Number of updates. */
    private JCacheMetricsSnapshot metricsSnapshot;
   ...
   @Nullable public List<Integer> nearValuesIndexes() {
     ...
     */
    public void metrics(JCacheMetricsSnapshot metrics) {
    ...
    @Override public boolean writeTo(ByteBuffer buf, MessageWriter writer) {
        ...
        switch (writer.state()) {
            ...
            case 6:
                if (!writer.writeMessage("metricsSnapshot", metricsSnapshot))
                    return false;
    ...
    @Override public boolean readFrom(ByteBuffer buf, MessageReader reader) {
        ...
        switch (reader.state()) {
            ...
            case 6:
                metricsSnapshot = reader.readMessage("metricsSnapshot");
