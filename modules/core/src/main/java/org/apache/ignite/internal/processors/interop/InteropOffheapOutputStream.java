...
/**
 * Interop offheap output stream.
 */
public class InteropOffheapOutputStream extends InteropAbstractOutputStream {
    /** Pointer. */
    private long ptr;
     ...
     * @param cap Capacity.
     */
    public InteropOffheapOutputStream(int cap) {
        this(0, cap);
    }
     ...
     * @param cap Capacity.
     */
    public InteropOffheapOutputStream(long ptr, int cap) {
    ...
    @Override protected void copyAndShift(Object src, long off, int len) {
        UNSAFE.copyMemory(src, off, null, ptr + pos, len);
