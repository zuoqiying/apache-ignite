...
import org.apache.ignite.internal.processors.cache.distributed.dht.atomic.GridCacheAtomicMetricsSelfTest;
...
public class IgniteCacheMetricsSelfTestSuite extends TestSuite {
    ...
    public static TestSuite suite() throws Exception {
        ...
        suite.addTestSuite(GridCacheAtomicMetricsSelfTest.class);
