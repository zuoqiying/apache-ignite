...
public class LuceneIndex implements AutoCloseable {
    ...
    /** */
    private final LuceneDirectory dir;
     ...
     */
    public LuceneIndex(GridKernalContext ctx, String cacheName, GridQueryTypeDescriptor type) throws IgniteCheckedException {
        this.ctx = ctx;
        this.cacheName = cacheName;
        this.type = type;

        dir = new LuceneDirectory(ctx.cache().cache(cacheName).context());
