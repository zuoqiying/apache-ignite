...
export default [
    ...
    {name: 'user', displayName: 'User', categoryDisplayName: 'User', field: 'userName', cellTemplate: USER_TEMPLATE, minWidth: 160, enableFiltering: true, pinned: true, filter: { placeholder: 'Filter by name...' }},
