...
/**
 * REST executor via ignite-rest-http.
 */
public class RestHttpExecutor implements RestExecutor {
     ...
     * Default constructor.
     */
    public RestHttpExecutor(String nodeUrl) {
    ...
    /** {@inheritDoc} */
    @Override public RestResult execute(boolean demo, String path, Map<String, Object> params,
