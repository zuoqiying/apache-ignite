...
module.exports = {
    ...
    inject: ['routes/public', 'routes/admin', 'routes/profiles', 'routes/demo', 'routes/clusters', 'routes/domains',
        'routes/caches', 'routes/igfss', 'routes/notebooks', 'routes/agents', 'routes/configurations', 'routes/statistics']
};

module.exports.factory = function(publicRoute, adminRoute, profilesRoute, demoRoute,
    clustersRoute, domainsRoute, cachesRoute, igfssRoute, notebooksRoute, agentsRoute, configurationsRoute, statisticsRoute) {
    return {
        register: (app) => {
            ...
            app.use('/statistics', _mustAuthenticated, statisticsRoute);
        }
    };
};
